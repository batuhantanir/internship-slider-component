...
export default function Home() {
  ...
  const mockData = [
    ...
    { "id": "1223cefc-099f-4a99-a55b-d7d6e6ec5770", "mainText": "batuhad", "subText": "tanoır", "buttonLink": "/", "buttonText": "button", "mainImage": "https://images.unsplash.com/photo-1475924156734-496f6cac6ec1?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80", "subTextColour": "#ff0000", "mainTextColour": "#ff0000", "buttonColour": "#ff0000", "buttonTextColour": "#ff0000", "bgColor": "linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(9,9,121,1) 35%, rgba(0,212,255,1) 100%)", "mainImageOpen": true, "MainTextOpen": true, "buttonOpen": true, "subTextOpen": true, "changePosition": false, "backgrounBlur": false, "bgImageOpen": false, "bgDarkness": true, "bgDarknessValue": 0.8 },
  ...
  useEffect(() => {
    !localStorage.getItem("localData") && localStorage.setItem("autoPlaySettings", JSON.stringify(mockData));
